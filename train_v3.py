"""
train_v3.py — MODEL 3: ConvNeXt V2 Tiny
RTX 3050 Laptop (4GB) optimised: AMP + batch_size=16 + num_workers=0
...
def train(args):
    ...
    print(f"\nMODEL 3 — ConvNeXt V2 Tiny | 4-class | {args.epochs} epochs")
    ...
    # num_workers=0 — fixes Windows multiprocessing freeze
...
if __name__ == "__main__":
    ...
    p.add_argument("--save_path",  default=r"D:\spine\decideing\models\best_model_v3.pth")
    train(p.parse_args())
